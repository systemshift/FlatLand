...
class GenerationRequest(BaseModel):
    ...
    model: str = "gpt-4.5-turbo"  # Default to GPT-4.5
...
async def generate_environment(request: GenerationRequest):
    """Generate a new environment from a text description using GPT-4.5"""
    try:
        # Initialize environment generator with the specified model
